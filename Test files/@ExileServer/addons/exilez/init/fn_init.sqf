...
ZombieRespect								= 25;               	// Respect per zombie kill
RoadKillBonus								= 50;               	// Bonus Respect if roadkill
...
Triggers = [Trigger_0,Trigger_1,Trigger_2,Trigger_3,Trigger_4,Trigger_5];
